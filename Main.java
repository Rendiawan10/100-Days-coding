...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Apakah angka1 lebih besar atau sama dengan angka2? " + (angka1 >= angka2));
        System.out.println("Apakah angka1 lebih kecil atau sama dengan angka2? " + (angka1 <= angka2));
    }
